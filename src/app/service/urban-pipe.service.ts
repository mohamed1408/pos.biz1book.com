...
export class UrbanPipeService {
  ...
  addStore(jstring) {
    ...
    return this.http.post("https://staging.urbanpiper.com/external/api/v1/stores/", jstring, {
  ...
  storeAction(platformData) {
    ...
    return this.http.post("https://staging.urbanpiper.com/hub/api/v1/location/", platformData, {
      headers: new HttpHeaders({
        "Authorization": "apikey biz_adm_clients_ggfbSgijDIRJ:5641ddc76592b65363b218f939a932a920b542ba",
        "Content-Type": "application/json",
      })
  ...
  catalogue(catalogue, storeId) {
    var data = "{\"categories\":[{\"ref_id\":\"C-125\",\"name\":\"Breads1\",\"description\":\"Remote category åß˙\",\"sort_order\":1,\"active\":true,\"img_url\":\"https://static.giantbomb.com/uploads/scale_small/0/6087/2437349-pikachu.png\"},{\"ref_id\":\"C-124\",\"name\":\"Sliders\",\"description\":\"Another one ˚∫∆˙∫\",\"sort_order\":1,\"active\":true,\"img_url\":\"https://static.giantbomb.com/uploads/scale_small/0/6087/2437349-pikachu.png\",\"parent_ref_id\":\"C-125\"}],\"items\":[{\"ref_id\":\"XX-12256\",\"title\":\"Whole grain4\",\"available\":true,\"description\":\"Super healthy\",\"sold_at_store\":true,\"price\":41.0,\"current_stock\":24,\"recommended\":true,\"food_type\":\"2\",\"category_ref_ids\":[\"C-125\"]},{\"ref_id\":\"XX-1226\",\"title\":\"Parsley\",\"description\":\"very taasty\",\"available\":false,\"sold_at_store\":true,\"img_url\":\"http://image.com/media/2017/03/20/B50_500_x_500.png\",\"sort_order\":123,\"price\":145.0,\"current_stock\":1,\"category_ref_ids\":[\"C-124\"]}],\"option_groups\":[{\"ref_id\":\"OG-1234\",\"title\":\"This G-1 group\",\"min_selectable\":1,\"max_selectable\":1,\"active\":true},{\"ref_id\":\"OG-1235\",\"title\":\"This G-2 group\",\"min_selectable\":1,\"max_selectable\":1,\"active\":true}],\"options\":[{\"ref_id\":\"opt-0112233\",\"title\":\"Opt integra 1\",\"description\":\"option through integration\",\"weight\":123,\"available\":true,\"price\":123.23,\"sold_at_store\":true,\"opt_grp_ref_ids\":[\"OG-1234\"],\"nested_opt_grps\":[\"OG-1235\"]},{\"ref_id\":\"opt-0112234\",\"title\":\"Opt integra 2\",\"description\":\"option through integration\",\"weight\":123,\"available\":true,\"price\":123.23,\"sold_at_store\":true,\"opt_grp_ref_ids\":[\"OG-1235\"]}],\"callback_url\":\"https://enp27ugn0clof.x.pipedream.net/\"}";
    console.log(catalogue);
    return this.http.post("https://staging.urbanpiper.com/external/api/v1/inventory/locations/" + storeId + "/", catalogue, {
      headers: new HttpHeaders({
        "Authorization": "apikey biz_adm_clients_ggfbSgijDIRJ:5641ddc76592b65363b218f939a932a920b542ba",
        "Content-Type": "application/json"
      })
  ...
  items(item) {
    ...
    console.log(data);
    return this.http.post("https://staging.urbanpiper.com/hub/api/v1/items/", item, {
      headers: new HttpHeaders({
        "Authorization": "apikey biz_adm_clients_ggfbSgijDIRJ:5641ddc76592b65363b218f939a932a920b542ba",
        "Content-Type": "application/json"
      })
